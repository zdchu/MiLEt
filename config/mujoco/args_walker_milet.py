...
def get_args(rest_args):
    ...
    parser.add_argument('--ent_reward_lambda', type=float, default=0.1)
    ...
    parser.add_argument('--lr_exp_policy', type=float, default=3e-4, help='learning rate (default: 7e-4)')
    ...
    parser.add_argument('--const_reward', type=float, default=0.1)
