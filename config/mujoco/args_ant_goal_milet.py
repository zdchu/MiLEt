...
def get_args(rest_args):
    ...
    parser.add_argument('--exp_label', default='milet', help='label (typically name of method)')
    ...
    parser.add_argument('--exp_policy_entropy_coef', type=float, default=0.001, help='entropy term coefficient')
    ...
    parser.add_argument('--vae_batch_num_trajs', type=int, default=50,
    ...
    parser.add_argument('--num_vae_updates_per_pretrain', type=int, default=1,
                        help='how many VAE update steps to take per meta-iteration')
    ...
    parser.add_argument('--encoder_gru_hidden_size', type=int, default=32, help='dimensionality of RNN hidden state')
    ...
    parser.add_argument('--vis_behavior', type=boolean_argument, default=False, help='visualisation interval, one eval per n updates')
    ...
    parser.add_argument('--vae', type=str, default='gmvae')
    parser.add_argument('--explore', type=boolean_argument, default=True)

    parser.add_argument('--gt', type=boolean_argument, default=False)
    parser.add_argument('--gau_lambda', type=float, default=0.01)
    parser.add_argument('--cat_lambda', type=float, default=0.001)
    parser.add_argument('--gau_prior_lambda', type=float, default=0.1)
    parser.add_argument('--ent_reward_lambda', type=float, default=0.2)

    parser.add_argument('--init_temp', default=0.8, type=float,
                    help='Initial temperature used in gumbel-softmax (recommended 0.5-1.0, default:1.0)')
    parser.add_argument('--min_temp', default=0.2, type=float, 
                    help='Minimum temperature of gumbel-softmax after annealing (default: 0.5)' )
    parser.add_argument('--decay_temp', default=1, type=int, 
                    help='Set 1 to decay gumbel temperature at every epoch (default: 1)')
    parser.add_argument('--const_reg', default=1, type=int)
    
    parser.add_argument('--lr_exp_policy', type=float, default=1e-4, help='learning rate (default: 7e-4)')
    parser.add_argument('--const_reward', type=float, default=-0.5)
    parser.add_argument('--stack_rnn', type=boolean_argument, default=True)
    parser.add_argument('--num_tasks', type=int, default=532)
    parser.add_argument('--sparse_reward', type=boolean_argument, default=False)
