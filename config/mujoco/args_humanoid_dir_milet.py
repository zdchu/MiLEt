...
def get_args(rest_args):
    ...
    parser.add_argument('--lr_policy', type=float, default=0.0001, help='learning rate (default: 7e-4)')
    ...
    parser.add_argument('--gau_lambda', type=float, default=0.001)
    parser.add_argument('--cat_lambda', type=float, default=0.0001)
    parser.add_argument('--gau_prior_lambda', type=float, default=0.1)
    parser.add_argument('--ent_reward_lambda', type=float, default=0.5)
    ...
    parser.add_argument('--num_vae_updates_per_pretrain', type=int, default=1,
                        help='how many VAE update steps to take per meta-iteration')
    parser.add_argument('--lr_exp_policy', type=float, default=0.0001, help='learning rate (default: 7e-4)')
    parser.add_argument('--const_reward', type=float, default=0.05)
