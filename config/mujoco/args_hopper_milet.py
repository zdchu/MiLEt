...
def get_args(rest_args):
    ...
    parser.add_argument('--state_loss_coeff', type=float, default=1, help='weight for state loss')
    ...
    parser.add_argument('--gau_lambda', type=float, default=0.0001)
    ...
    parser.add_argument('--exp_policy_entropy_coef', type=float, default=0.01, help='entropy term coefficient')
